...
my_name = "Kieran" # Change to your name
my_github_account = "https://github.com/Caperadium" # Change to your GitHub account
my_hobby = "Cars" # Change to your hobby
...
project_third_interested = project_types[1]
...
The projects I'd like to do in this term are: {project_interested}, {project_another_interested} and {project_third_interested}.
