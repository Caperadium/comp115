...
practice_for_index_1 returns the index of the first instance of a specified number in a list
practice_for_index_2 also returns the index of the first instance of a specified number of a list
...
practice_for_index_3 returns the index of the last instance of a specified number in a list
...
def more_than_2(strings):
    ...
    # Identify strings occurring more than two times
